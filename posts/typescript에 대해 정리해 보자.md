...
선언적 머지([declaration merging](https://www.typescriptlang.org/docs/handbook/declaration-merging.html))를 예로 들 수 있다. `Array.prototype.`concat의 경우 typescript의 lib/es5.d.ts에서 선언을 찾을수 있다.  하지만 `Array.profind`는 어떤가 lib/lib.es2015.core.d.ts에서 찾을수 있다